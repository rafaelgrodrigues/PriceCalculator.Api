...
public class NetCalculatorByVatTest
{
    ...
    public async Task Calculate_When_ValidInputs(decimal vatValues, int vatPercentage, decimal expectedResult)
    {
        var result = await netCalculatorByVat.Calculate(vatValues, vatPercentage);
